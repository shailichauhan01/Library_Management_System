...
<?php
	...
	mysqli_query($db,"UPDATE `message` set statuss='yes' where sender='admin' and username='$_SESSION[login_user]' ;");
?>

<div class="wrapper">
	<div style="height: 70px; width: 100%; background-color: #121491; text-align: center; color:white; ">
